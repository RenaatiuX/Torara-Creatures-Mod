...
import rena.toraracreatures.core.util.FeatureUtil;
import rena.toraracreatures.core.util.MLBlockTags;
import rena.toraracreatures.util.config.TCMushroomConfig;

import java.util.Random;

public abstract class TCAbstractMushroomFeature <T extends TCMushroomConfig> extends Feature<T> {

    public TCAbstractMushroomFeature(Codec<T> configCodec) {
        super(configCodec);
    }
     ...
     */
    public static boolean isDesiredGroundwDirtTag(TCMushroomConfig config, IWorldGenerationBaseReader reader, BlockPos pos, Block... desiredGroundBlock) {
