...
public abstract class TCHugeMushroom {

    @Nullable
    protected abstract ConfiguredFeature<TCMushroomConfig, ?> getHugeMushroomFeature(Random random);
    ...
    public boolean withSpawner(ISeedReader worldIn, ChunkGenerator chunkGenerator, BlockPos pos, BlockState blockUnder, Random random) {
        ConfiguredFeature<TCMushroomConfig, ?> abstractMushroomFeature = this.getHugeMushroomFeature(random);
    ...
    public static abstract class Massive extends TCHugeMushroom {
        ...
        @Nullable
        protected abstract ConfiguredFeature<TCMushroomConfig, ?> getMassiveMushroomFeature(Random random);
        ...
        public boolean massiveMushroom(ISeedReader worldIn, ChunkGenerator chunkGenerator, BlockPos pos, BlockState blockUnder, Random random, int xOffset, int zOffset) {
            ConfiguredFeature<TCMushroomConfig, ?> abstractMushroomFeature = this.getMassiveMushroomFeature(random);
            if (abstractMushroomFeature == null) {
                return false;
            } else {
